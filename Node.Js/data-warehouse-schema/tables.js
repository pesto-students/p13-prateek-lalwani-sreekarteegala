...
/*
    ...
    Insert into cities (city, state) values('Suryapet', 'Telangana');
    ...
    Insert into warehouses(wh_name, location, city_id) values('Warehouse 1', 'Telangana', 1);
    Insert into warehouses(wh_name, location, city_id) values('Warehouse 2', 'Telangana', 2);
